...
The engine uses an alpha-beta search with iterative deepening as its main algorithm.
  ...
  - **N512 eval net (v0.4.0) + time management (v0.4.1).** Covered under *Position Evaluation* and *Time management* above; together **+138 Elo** over 0.3.18. **v0.4.1 is the current release** (`threading`).
