...
{   
    ...
    void AccumulatorState::initialize(const BitPosition &position, const Transformer &transformer)
    {
    ...
    inline void AccumulatorState::addAndRemoveOnInput(int subIndexAdd, int subIndexRemove, bool turn, const Transformer &transformer)
    {
    ...
    inline void AccumulatorState::addOnInput(int subIndex, bool turn, const Transformer &transformer)
    {
    ...
    inline void AccumulatorState::removeOnInput(int subIndex, bool turn, const Transformer &transformer)
    {
        assert(subIndex >= 0 && subIndex < 640);
        if (not turn)
...
#ifndef NDEBUG
    void AccumulatorStack::verifyTopAgainstFresh(const BitPosition &pos, bool turn, const Transformer &transformer)
    {
    ...
    void AccumulatorStack::reset(const BitPosition &rootPos, const Transformer &transformer)
    {
        m_current_idx = 1;
    ...
    void AccumulatorStack::changeWhiteKingPosition(int kingPos, const Transformer &transformer)
    {
    ...
    void AccumulatorStack::changeBlackKingPosition(int kingPos, const Transformer &transformer)
    {
        assert(kingPos >= 0 && kingPos < 64);
    ...
    inline int AccumulatorStack::getStackKingPosition(int color) const
    {
    ...
    void AccumulatorStack::forward_update_incremental(const int begin, bool turn, const Transformer &transformer)
    {
    ...
    void AccumulatorStack::applyIncrementalChanges(AccumulatorState &curr, const AccumulatorState &prev, bool turn, const Transformer &transformer)
    {
    ...
    bool Transformer::load(const std::string &modelDir = "models/NNUEU_quantized_model_v4_param_350_epoch_10/")
    {
        try
        {
