...
private:
    ...
    unsigned short m_white_king_position{getLeastSignificantBitIndex(m_white_king_bit)};
    unsigned short m_black_king_position{getLeastSignificantBitIndex(m_black_king_bit)};
    // ply number
...
public: // I define the short member functions here, the rest are defined in bitposition.cpp
    ...
    std::vector<Capture> captureMoves() const;
